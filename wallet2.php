    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/wallets/2.png">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/wallets/2.png">
                    <img class="thumbnail" src="img/wallets/(wallet2.html)2.png">
                    <img class="thumbnail" src="img/wallets/(wallet2.html)3.png">
                    <img class="thumbnail" src="img/wallets/(wallet2.html)4.png">
                    <img class="thumbnail" src="img/wallets/(wallet2.html)5.png">
                    <img class="thumbnail" src="img/wallets/(wallet2.html)6.png">
                    <img class="thumbnail" src="img/wallets/(wallet2.html)7.png">
                    <img class="thumbnail" src="img/wallets/(wallet2.html)8.png">
                    <img class="thumbnail" src="img/wallets/(wallet2.html)9.png">
                </div>
            ...
            <div class="breadcrumb2">
                ...
                <span class="active">Assorted Design Canvas Wallets 2</span>
            </div>
        </div>
        <div class="col-6">
            <div class="breadcrumb">
                <span><a class = "home" href="home.php">Home</a></span>
                <span><a class = "cat" href="category_wallet.php">Wallet</a></span>
                <span class="active">Assorted Design Canva Wallets 2</span>
            </div>
    
            <div class="product">
                <div class="product-title">
                    <h2>Assorted Design Canvas Wallets (Front and Back Print)</h2>
                </div>
    
                <div class="product-price">
                    <span id = "price" class="offer-price">₱55.00</span>
                    <span class="sale-price"></span>
                </div>
    
                <div class="product-details">
                    <h3>Description</h3>
                    <p>Introducing our stylish and functional wallets, <br>designed to keep your valuables organized and secure<br> while also showcasing your unique style.</p>
                </div>
                <br>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/HWGL-6X4in-WALLETS-WITH-LINING-i.300423350.23923458643?sp_atk=3c8a41da-7ee0-4aa3-947f-ae8b5900b6db&xptdk=3c8a41da-7ee0-4aa3-947f-ae8b5900b6db"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
