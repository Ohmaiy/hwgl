    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/others/m1.jpg">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/others/m1.jpg">
                    <img class="thumbnail" src="img/others/(mask.html)2.jpg">
                    <img class="thumbnail" src="img/others/(mask.html)3.jpg">
                    <img class="thumbnail" src="img/others/(mask.html)4.jpg">
                    <img class="thumbnail" src="img/others/(mask.html)5.jpg">
                    <img class="thumbnail" src="img/others/(mask.html)6.jpg">
                    <img class="thumbnail" src="img/others/(mask.html)7.jpg">
                    <img class="thumbnail" src="img/others/(mask.html)8.jpg">
                    <img class="thumbnail" src="img/others/(mask.html)9.jpg">
                </div>
            ...
            <div class="breadcrumb2">
                ...
                <span class="active">Assorted Designs Face Masks</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Assorted Designs Face Masks</h2>
                </div>
    
                <div class="product-price">
                    <span id = "price" class="offer-price">₱80.00</span>
                    <span class="sale-price"></span>
                </div>
    
                <div class="product-details">
                    <h3>Description</h3>
                    <p>In these uncertain times, staying safe and protected is more important than ever. Order your HWGL fabric face masks now— made from high-quality materials, our masks are designed to keep you safe while ensuring maximum breathability and comfort.</p>
                </div>
                <br>
                <div class="product-size">
                    <h4>Sizes</h4>
                    <button id = "but1" class = "size-layout" onclick="size1()">Standard Size</button>
                </div>
                ...
                <div class="product-btn-group">
                    <a href="https://www.facebook.com/media/set/?set=a.1510424745825854&type=3"><div class="button buy-now"><i class='fa-brands fa-facebook' ></i> Facebook</div></a>
