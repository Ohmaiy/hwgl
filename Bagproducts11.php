    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/bags/product/62.jpg">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/bags/product/62.jpg">
                    <img class="thumbnail" src="img/bags/product/63.jpg">
                    <img class="thumbnail" src="img/bags/product/64.jpg">
                    <img class="thumbnail" src="img/bags/product/65.jpg">
                    <img class="thumbnail" src="img/bags/product/66.jpg">
                </div>
            ...
            <div class="breadcrumb2">
                ...
                <span class="active">Avril Lavigne-Inspired</span>
            </div>
        ...
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Avril Lavigne-Inspired Tote Bag</h2>
                </div>
                ...
                <div class="product-details">
                    <h3>Description</h3>
                    <p>Celebrate your love for one of the most iconic pop-punk rockers of our time with our Avril Lavigne-inspired tote bag! This stylish and functional accessory is the perfect way to show your appreciation for the Canadian singer-songwriter and her catchy, rebellious tunes.</p>
                </div>
                <br>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/Avril-Lavigne-Album-High-Quality-Tote-Bag-i.300423350.7292770305?sp_atk=9867f29b-ee96-4fcd-aa62-ab9490932fca&xptdk=9867f29b-ee96-4fcd-aa62-ab9490932fca"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
