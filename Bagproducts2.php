...
<body>
    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/bags/product/23.jpg">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/bags/product/23.jpg">
                    <img class="thumbnail" src="img/bags/product/24.jpg">
                    <img class="thumbnail" src="img/bags/product/25.jpg">
                    <img class="thumbnail" src="img/bags/product/26.jpg">
                </div>
            ...
            <div class="breadcrumb2">
                ...
                <span class="active">Black Canvas</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                ...
                <div class="product-details">
                    <h3>Description</h3>
                    <p>Bring with you the sophisticated style, sleek black color, and timeless & understated elegance of our black canvas tote bags!</p>
                </div>
                <br>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/Black-12x14-and-14x16-inches-Canvas-Tote-Bag-i.300423350.11791944434?xptdk=5f0f030b-304a-4a1e-a88a-dc24de9b667a"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
  ...
  <script type="text/javascript">
    ...
    function size2() {
    document.getElementById("price").innerHTML = "₱175.00";  
