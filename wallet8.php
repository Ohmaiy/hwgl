    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/wallets/8.jpg">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/wallets/8.jpg">
                    <img class="thumbnail" src="img/wallets/(wallet8.html)2.jpg">
                    <img class="thumbnail" src="img/wallets/(wallet8.html)3.jpg">
                    <img class="thumbnail" src="img/wallets/(wallet8.html)4.jpg">
                    <img class="thumbnail" src="img/wallets/(wallet8.html)5.jpg">
                    <img class="thumbnail" src="img/wallets/(wallet8.html)6.jpg">
                    <img class="thumbnail" src="img/wallets/(wallet8.html)7.jpg">
                </div>
                <img id="slideRight" class="arrow" src="img\arrowright.png">
            </div>
            <div class="breadcrumb2">
                <span><a class = "home" href="home.php">Home </a></span>
                <span><a class = "cat" href="category_coinpurse.php"> Coin Purse </a></span>
                <span class="active">Assorted Design Canvas Coin Purse & Wallets 2</span>
            </div>
        </div>
        <div class="col-6">
            <div class="breadcrumb">
                <span><a class = "home" href="home.php">Home</a></span>
                <span><a class = "cat" href="category_coinpurse.php">Wallet</a></span>
                <span class="active">Assorted Design Canvas Coin Purse & Wallets 2</span>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/Personalized-Customized-Giveaway-Canvas-Coin-Purse-and-Wallet-i.300423350.9165930553?sp_atk=dbdd064c-fcc4-4784-b2ee-c8d24fb7608f&xptdk=dbdd064c-fcc4-4784-b2ee-c8d24fb7608f"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
