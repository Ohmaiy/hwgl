    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/others/1.png">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/others/1.png">
                    <img class="thumbnail" src="img/others/(hat.html)2.png">
                    <img class="thumbnail" src="img/others/(hat.html)3.png">
                    <img class="thumbnail" src="img/others/(hat.html)4.png">
                </div>
            ...
            <div class="breadcrumb2">
                ...
                <span class="active">Reversible Kiddie Bucket Hat</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Reversible Kiddie Bucket Hat</h2>
                </div>
    
                <div class="product-price">
                    <span id = "price" class="offer-price">₱155.00</span>
                    <span class="sale-price"></span>
                </div>
    
                <div class="product-details">
                    <h3>Description</h3>
                    <p>With a range of colors that can be easily mixed and matched with your child's wardrobe, our reversible kiddie bucket hats are the perfect accessory for your little ones to stay protected from the sun in style!</p>
                </div>
                <br>
                <div class="product-size">
                    <h4>Design</h4>
                    <button id = "but1" class = "size-layout" onclick="size()">Yellow-Pink</button>
                    <button class = "size-layout2" onclick="size()">Blue-Red</button>
                </div>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/Reversible-Kiddie-Bucket-Hat-i.300423350.23719378831?sp_atk=761c020b-dd9e-4234-8176-2131de343564&xptdk=761c020b-dd9e-4234-8176-2131de343564"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
