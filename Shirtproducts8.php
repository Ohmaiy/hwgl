    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/shirts/EDs1.png">
            ...
            <img id="slideLeft" class="arrow" src="img/arrowleft.png">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src= "img/shirts/EDs1.png">
                    <img class="thumbnail active" src= "img/shirts/EDs2.png">
                    <img class="thumbnail active" src= "img/shirts/EDs3.png">
                    <img class="thumbnail active" src= "img/shirts/EDs4.png">
                    <img class="thumbnail active" src= "img/shirts/EDs5.png">
            ...
            <span class="active">Statement Shirt Everyday Shirt</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Statement Shirt -  Everyday Shirt </h2>
                </div>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/Statement-Shirt-Everyday-shirt-Moday-Tuesday-Wednesday-Thursday-Friday-Saturday-Sunday-i.300423350.4353342928?sp_atk=5a16cb30-54f6-4e35-9042-61cbf713a261&xptdk=5a16cb30-54f6-4e35-9042-61cbf713a261"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>   
                </div>
            </div>
        </div>
    </div>
