    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/others/c1.png">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/others/c1.png">
                    <img class="thumbnail" src="img/others/(calendar.html)2.png">
                    <img class="thumbnail" src="img/others/(calendar.html)3.png">
                </div>
            ...
            <div class="breadcrumb2">
                ...
                <span class="active">Hanging or Wall Calendar Year 2023</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Hanging/Wall Calendar Year 2023</h2>
                </div>
                ...
                <div class="product-details">
                    <h3>Description</h3>
                    <p>Don't miss out on the chance to make 2023 a year of beauty and productivity. Get your own HWGL Canvas Hanging/Wall 2023 Calendar today display it on any wall without taking up valuable desk or counter space!</p>
                </div>
                <br>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/Aesthetic-Hanging-Wall-Calendar-Year-2023-12cm-x-15cm-i.300423350.19559144621?sp_atk=4840df40-724c-4272-bda9-23943f072377"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
