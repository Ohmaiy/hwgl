    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/shirts/br1.png">
            ...
            <img id="slideLeft" class="arrow" src="img/arrowleft.png">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src= "img/shirts/br2.png">
                    <img class="thumbnail active" src= "img/shirts/br1.png">
            ...
            <span class="active">Be the Reason</span>
            </div>
        </div>
        <div class="col-6">
        <div class = "breadcrumb">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Statement Shirt – Be the Reason </h2>
                </div>
                ...
                <div class="product-details">
                    <h3>Description</h3>
                    <p>Inspire and encourage others to see the goodness of God in the world. Get this shirt today and be a person of faith who wants to make a positive impact in the lives of those around you!</p>
                </div>
                <br>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/HWGL-Statement-Shirt-Be-The-Reason-Gospel-Shirt-Unisex-Size-Daily-Outfit-i.300423350.5248496633?sp_atk=51b32057-2618-4a0e-b598-34cc9cf6dcee&xptdk=51b32057-2618-4a0e-b598-34cc9cf6dcee"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
