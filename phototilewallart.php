    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/others/p1.jpg">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/others/p1.jpg">
                    <img class="thumbnail" src="img/others/(phototilewallart)2.jpg">
                    <img class="thumbnail" src="img/others/(phototilewallart)3.jpg">
                    <img class="thumbnail" src="img/others/(phototilewallart)4.jpg">
                </div>
            ...
            <div class="breadcrumb2">
                ...
                <span class="active">Photo Tile Wall Art</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Photo Tile Wall Art</h2>
                </div>
    
                <div class="product-price">
                    <span id = "price" class="offer-price"></span>
                    <span class="sale-price"></span>
                </div>
    
                <div class="product-details">
                    <h3>Description</h3>
                    <p>Add a touch of elegance and creativity to any room in your home or office with our Photo Wall Art! With a wide selection of designs and patterns to choose from, you can now create a one-of-a-kind look that reflects your personal style.</p>
                </div>
                <br>
                ...
                <div class="product-btn-group">
                    <a href="https://www.facebook.com/hwglph/posts/pfbid0zWAFkziAY6WhGCEMZVG3tYVw5hJxUpiS9gLZ17Waz1Mn9fW4S2z6Kz35WQybW77Dl"><div class="button buy-now"><i class='fa-brands fa-facebook' ></i> Facebook</div></a>
