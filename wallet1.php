    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/wallets/1.png">
            ...
            <img id="slideLeft" class="arrow" src="img/arrowleft.png">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src="img/wallets/1.png">
                    <img class="thumbnail" src="img/wallets/(wallet1.html)2.png">
                </div>
                <img id="slideLeft" class="arrow" src="img/arrowright.png">
            </div>
            <div class="breadcrumb2">
                <span><a class = "home" href="home.php">Home </a></span>
                <span><a class = "cat" href="category_wallet.php"> Wallet </a></span>
                <span class="active">Assorted Design Canvas Wallets 1</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Assorted Design Canvas Wallets 1 (Front and Back Print)</h2>
                </div>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/HWGL-WALLETS-FRONT-AND-BACK-PRINT-WITH-LINING-i.300423350.15296236294?sp_atk=eb5b888b-cff9-4d47-a154-b3a7d1f6965d&xptdk=eb5b888b-cff9-4d47-a154-b3a7d1f6965d"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
