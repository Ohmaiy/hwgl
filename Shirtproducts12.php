    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/shirts/AGU1.png">
            ...
            <img id="slideLeft" class="arrow" src="img/arrowleft.png">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src= "img/shirts/AGU2.png">
                    <img class="thumbnail active" src= "img/shirts/AGU3.png">
                    <img class="thumbnail active" src= "img/shirts/AGU4.png">
                    <img class="thumbnail active" src= "img/shirts/AGU5.png">
                    <img class="thumbnail active" src= "img/shirts/AGU1.png">
            ...
            <span class="active">Amazing Grace</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Statement Shirt - Amazing Grace </h2>
                </div>
                ...
                <div class="product-details">
                    <h3>Description</h3>
                    <p> Our statement shirt featuring "Amazing Grace" in an Amazon-inspired font is both stylish and inspiring. It's a reminder to embody grace and compassion in our lives while adding a touch of elegance to any outfit. </p>
                </div>
                <br>
