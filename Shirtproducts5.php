    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/shirts/OP1.png">
            ...
            <div id="slide-wrapper">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src= "img/shirts/OP2.png">
                    <img class="thumbnail active" src= "img/shirts/OP3.png">
                    <img class="thumbnail active" src= "img/shirts/OP4.png">
                    <img class="thumbnail active" src= "img/shirts/OP5.png">
                    <img class="thumbnail active" src= "img/shirts/OP1.png">
            ...
            <span class="active">One Piece Inspired Shirt</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>One Piece Inspired Shirt</h2>
                </div>
                ...
                <div class="product-details">
                    <h3>Description</h3>
                    <p>Capture the spirit and adventures of One Piece, and bring it to life in a unique and exciting way!</p>
                </div>
                <br>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/ONE-PIECE-Anime-Unisex-Shirt-i.300423350.8033615936?sp_atk=4a852540-61d4-48ba-9ad7-b1d69f98e163&xptdk=4a852540-61d4-48ba-9ad7-b1d69f98e163"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
