    ...
    <div class="main-content">
      <div id="content-wrapper" class = "fadeInUp" style= "animation-delay: 1s;">
        ...
        <div class="column">            
                ...
                <img id= featured src="img/shirts/po1.png">
            ...
            <img id="slideLeft" class="arrow" src="img/arrowleft.png">
                ...
                <div id="slider">
                    ...
                    <img class="thumbnail active" src= "img/shirts/po1.png">
                    <img class="thumbnail active" src= "img/shirts/po2.png">
                    <img class="thumbnail active" src= "img/shirts/po3.png">
            ...
            <span class="active">Praise Over Problems</span>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="product">
                <div class="product-title">
                    <h2>Statement Shirt – Praise Over Problems </h2>
                </div>
                ...
                <div class="product-details">
                    <h3>Description</h3>
                    <p>Get your "Praise Over Problem" statement shirt today and let the world know that you are a person of faith who puts their trust in the Lord and focuses on the positive!</p>
                </div>
                <br>
                ...
                <div class="product-btn-group">
                    ...
                    <a href="https://shopee.ph/HWGL-Gospel-Statement-Shirt-Praise-Over-Problem-Unisex-i.300423350.7248493887?sp_atk=d374e6f9-4dec-4642-a07e-cd537cc83454&xptdk=d374e6f9-4dec-4642-a07e-cd537cc83454"><div class="button add-cart"><i class='bx bxs-cart' ></i> Shopee</div></a>
